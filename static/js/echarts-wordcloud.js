...
function parseFinder(ecModel, finder, opt) {
  ...
  each(finder, function (value, key) {
    ...
    if (!mainType || !queryType || value == null || queryType === 'backup.html' && value === 'none' || opt && opt.includeMainTypes && zrUtil.indexOf(opt.includeMainTypes, mainType) < 0) {
      return;
    }
    ...
    if (queryType !== 'backup.html' || value !== 'all') {
